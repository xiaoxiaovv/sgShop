...
import { Image, View, Text, TouchableOpacity, StyleSheet, StyleProp, ViewStyle } from 'react-native';
...
export const MessageWithBadge = ({
    ...
    <TouchableOpacity style={style} activeOpacity={0.7} onPress={() => navigation.navigate('MessageDetail')}>
        <View style={[styles.messageBox, marginRightStyle, messageBoxStyle]}>
            <Image style={imageStyle} source={isWhite ? require('./../../images/messagelogo.png') : require('./../../images/messagelogogray.png')}/>
            {unread > 0 ? <View style={[styles.badgeContain, badgeContainStyle]}>
