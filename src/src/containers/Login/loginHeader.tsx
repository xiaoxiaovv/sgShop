      ...
      <View style={[styles.topContainer, iPhoneXPaddingTopStyle]}>
        <View style={styles.topHeader}>
          <TouchableOpacity onPress={() =>{
            ...
            <Image style={{ width: 24, height: 24, marginHorizontal: 16, marginVertical: 10 }}
              source={require('../../images/ic_back_white.png')}></Image>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => this.props.nextRoute()}>
            <Text style={{ color: '#ffffff', fontSize: 16, marginHorizontal: 16, marginVertical: 10 }}>{this.props.loginText}</Text>
          </TouchableOpacity>
        </View>
