...
export default class cell extends Component {
    ...
    componentDidMount() {
        ...
        const newUrl = `${Config.API_URL}v3/mstore/sg/credit/findCreditDetail.html?searchType=0&startIndex=${page}&pageSize=20`;
        // 进入页面首先请求接口数据
        axios({
              method: "get",
              url: newUrl,
          ...
          {!this.state.truedata.length 
              ...
              : <FlatList
                  ...
                  onEndReached={() => {
                    ...
                    const myPage = `${Config.API_URL}v3/mstore/sg/credit/findCreditDetail.html?searchType=0&startIndex=${newPage}&pageSize=20`;
                    Log(myPage);
                    axios({
                          method:"get",
                          url: myPage,
