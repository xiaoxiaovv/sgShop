...
export default class MiddleMsgComp extends PureComponent<ICommonInterface> {
            ...
            renderItem={({item}) => (
              <TouchableOpacity activeOpacity={0.7} onPress={() => goGoodsDetail(item.relationId)}>
                <View key={item.id} style={styles.item}>
                  <Image style={styles.imgStyle} resizeMode='contain' source={{uri: cutImgUrl(item.pic, 200, 200, true)}}/>
