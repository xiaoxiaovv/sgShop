...
class WebViewAndroid extends React.Component {
  ...
  */
  ...
  shouldOverrideUrlLoading = (event ) => {
    var {shouldOverrideUrlLoading} = this.props;
    shouldOverrideUrlLoading && shouldOverrideUrlLoading(event);
  };
}

var RCTWebView = requireNativeComponent('RCTWebViewAndroid', WebViewAndroid, WebViewAndroid.extraNativeComponentConfig);
